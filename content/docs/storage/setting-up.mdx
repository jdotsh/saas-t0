...
1. First, go to your local instance of Supabase client and create a new bucket. If you followed the steps in the [previous section](/docs/configure/supabase/local),
   ...
   <Image
     src="/images/supabase-storage-1.png"
...
<Image
  src="/images/supabase-storage-2.png"
  alt="Supabase Storage"
  width={600}
  height={400}
/>
...
<Image
  src="/images/supabase-storage-3.png"
  alt="Supabase Storage"
  width={600}
  height={400}
/>
...
<Image
  src="/images/policy-anonymous-1.png"
  alt="Policy for Anonymous Users"
  width={600}
  height={400}
/>
...
<Image
  src="/images/policy-authenticated-1.png"
  alt="Policy for Authenticated Users"
  width={600}
  height={400}
/>
